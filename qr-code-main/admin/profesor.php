...
<div class = "container" id = "admincontainer">
    <div class = "row" id = "adminrow1">
        <div class = "col">
            <form action = "">
                <button type = "submit" class = "btn btn-block btn-danger"><b>IZBRISI PROFESORA</b></button>
                <button class = "btn btn-block btn-warning"><b>PREGLED PROFESORA</b></button>
                <a class="btn btn-block btn-primary" href="./noviProfesor.php" id="adminbutton"><b>DODAJ NOVOG PROFESORA</b></a>
            </form>
        </div>
    </div>
</div>
